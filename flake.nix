      ...
      in
      {
        options.boot.nmbl = {
          ...
          bootMode = lib.mkOption {
            type = lib.types.enum [ "mbr" "gpt-bios" "gpt-uefi" ];
            default = "gpt-uefi";
          ...
          kernelPackage = lib.mkOption {
            ...
            description = "Pinned kernel version for the bootloader";
          };

          kernelModules = lib.mkOption {
            type = lib.types.listOf lib.types.str;
            default = [ ];
            description = "Kernel modules to include in the initramfs (not inherited from system)";
          };
          ...
          fileSystems = lib.mkOption {
            ...
            description = "Filesystems to mount (readonly)";
          };
          ...
          kernelParams = lib.mkOption {
            ...
            description = "Extra kernel parameters only for the NMBL kernel";
          };

          timeoutSeconds = lib.mkOption {
            type = lib.types.int;
            default = 3;
            description = "Timeout in seconds before auto-selecting default entry";
          };
          ...
          serialConsole = lib.mkOption {
            ...
            description = "Serial console for input/output";
          };
        };
          ...
          system.build.nmblInitramfs = 
            let
              ...
              initScript = pkgs.writeScript "init" ''
                ...
                # Parse grub entries or nixos system profiles
              ...
              initramfs = pkgs.makeInitrd {
                contents = [
                  ...
                  # Include only necessary kernel modules
                  {
          ...
          system.build.nmblBootConfig = 
            let
              ...
              kernelParams = lib.concatStringsSep " " (
                cfg.kernelParams ++ 
                lib.optional (cfg.serialConsole != null) "console=${cfg.serialConsole}"
              );
            in
