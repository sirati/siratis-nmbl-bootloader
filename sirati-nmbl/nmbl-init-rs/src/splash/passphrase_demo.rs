...
//
// Input strategy: this demo polls crossterm::event directly. P1's
// SplashInput shim is not required; when P1 lands, swap the polling
// block in `run` for the new type.
