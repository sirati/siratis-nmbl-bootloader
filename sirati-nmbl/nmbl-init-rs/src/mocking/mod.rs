...
async fn run_modal_error(console: &mut MockConsole, args: &[String]) -> Result<()> {
...
async fn run_modal_confirm(console: &mut MockConsole, args: &[String]) -> Result<()> {
...
async fn run_modal_buttons(console: &mut MockConsole, args: &[String]) -> Result<()> {
...
async fn run_wrong_password(console: &mut MockConsole, args: &[String]) -> Result<()> {
...
async fn run_passphrase(console: &mut MockConsole, args: &[String]) -> Result<()> {
...
async fn run_resize(console: &mut MockConsole, args: &[String]) -> Result<()> {
...
async fn run_boot_status(console: &mut MockConsole, args: &[String]) -> Result<()> {
...
async fn run_emergency(_console: &mut MockConsole, args: &[String]) -> Result<()> {
